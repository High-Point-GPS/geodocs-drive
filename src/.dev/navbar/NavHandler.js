    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.hpgpsFilemanagerDrive.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.hpgpsFilemanagerDrive.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'hpgpsFilemanagerDrive'){
                    geotab.addin.hpgpsFilemanagerDrive.blur();
                } else {
                    geotab.addin.hpgpsFilemanagerDrive.focus(global.api, global.state);
                }
            }
        }, 100);
    }
